                        ...
                        <div class="">
                            ...
                            <form class="" action="" method="post">
                                ...
                                <?php foreach($loaddm as $row){
                                    extract($row);
                                    ?>  
                                    <option value="<?= $id ?>"><?= $Danhmuc?></option>
                                    <?php }?>
                                </select>
                                <select name="gia" id="short">
                                <option hidden value="">Chọn giá</option>
                                    <option value="0 AND 250000">0 - 250.000VND</option>
                                    <option value="250000 AND 500000">250.000 - 500.000VND</option>
                                    <option value="500000 AND 1000000">500.000 - 1 triệu</option>
                                </select>
