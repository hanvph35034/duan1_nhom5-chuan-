      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <!-- Add icons to the links using the .nav-icon class
               ...
               <li class="nav-item">
                <a href="../QTBL/list.html" class="nav-link">Quản Trị bình luận </a>
              </li>
            <li class="nav-item">
              <a href="../QTDM/list.html" class="nav-link">Quản Trị danh mục </a>
            </li>
            <li class="nav-item">
              <a href="../QTKH/list.html" class="nav-link">Quản Trị Khách hàng </a>
            </li>
            <li class="nav-item">
              <a href="../QTKM/list.html" class="nav-link">Quản Trị Khuyến mại </a>
            </li>
            <li class="nav-item">
              <a href="../QTSP/list.html" class="nav-link">Quản Trị sản phẩm </a>
            </li>
            <li class="nav-item">
              <a href="../QTBT/list.html" class="nav-link">Quản Trị biến thể </a>
            </li>
